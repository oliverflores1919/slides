...
slides:
 ...
 - title: Funcionamiento 
   list-data: •	Recepción de señales. Reciben señales de control desde un sistema de control o un microcontrolador. •	Conversión de energía. Utilizan motores eléctricos (DC, AC, servos) para transformar la energía eléctrica en movimiento. •	Movimiento. Generan el movimiento deseado, ya sea lineal o rotacional, según su tipo.
